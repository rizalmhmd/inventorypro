...
<head>
    ...
    <title>Confirm Password - InventoryPro</title>
...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="security-notice animate-fade-in" style="animation-delay: 0.3s;">
            ...
            <form method="POST" action="{{ route('password.confirm') }}">
                ...
                <div class="btn-container animate-fade-in" style="animation-delay: 0.5s;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (passwordField) {
                setTimeout(() => passwordField.focus(), 400);
            }
        });
    </script>
</body>
