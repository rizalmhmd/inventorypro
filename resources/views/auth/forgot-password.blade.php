...
<head>
    ...
    <title>Reset Password - InventoryPro</title>
    ...
    <div class="container">
        <div class="content">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <button type="submit" class="btn btn-primary animate-fade-in" style="animation-delay: 0.4s;">
                    <i class="fas fa-paper-plane"></i> Email Password Reset Link
                </button>
            </form>

            <div class="login-link animate-fade-in" style="animation-delay: 0.5s;">
