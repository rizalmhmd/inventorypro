...
@section('title', 'Stok Masuk - Inventory System')
                ...
                <div class="form-group full-width">
                    ...
                    <select id="product_id" name="product_id" class="form-select @error('product_id') input-error @enderror" required style="color: #f3f4f6;">
                        ...
                        @foreach($products as $p)
                            <option value="{{ $p->id }}" {{ old('product_id') == $p->id ? 'selected' : '' }} style="color: #f3f4f6; background: #1f2937;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Jalankan styling setelah DOM loaded
        styleSelectDropdown();
